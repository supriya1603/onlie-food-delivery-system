...
<head>
    ...
    <title>Fantasy Restaurant Greater Noida</title>
...
<div class="header-1">
    ...
    <a href="#" class="logo"> <i class="fas fa-utensils"></i>Fantasy Restaurant Greater Noida </a>

    <h3 class="call"> <i class="fas fa-phone"></i> call now : +918674913507 </h3>
...
<div class="content">
    ...
    <p>Fantasy Restaurant is the bestfantasy Restaurant i greater Noida, which you can found amazing Food from around the world. </p>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p> <i class="fas fa-map-marker-alt"></i>greater noida, india 843302 </p>
            <p> <i class="fas fa-envelope"></i>fantasyrestuarent@gmail.com </p>
            <p> <i class="fas fa-globe"></i> www.fantasyrestuarent.in </p>
        </div>

    </div>

<h1 class="credit"> created by <span>Supriya</span> | all rights reserved! </h1>
